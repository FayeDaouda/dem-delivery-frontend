        ...
        listener: (context, state) {
          if (state is PassActivationSuccess) {
            ...
            Future.delayed(const Duration(seconds: 2), () async {
              ...
              final driverType = (await storage.getDriverType())?.toUpperCase();
              if (!context.mounted) return;
              final route = driverType == 'VTC'
                  ? DriverVtcRoutes.home
                  : DriverMotoRoutes.home;
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: DEMColors.primary.withValues(alpha: 0.1),
            ...
            child: Row(
              children: [
                const Icon(Icons.info_outline, color: DEMColors.primary),
  ...
  Widget _buildPassCard(BuildContext context, dynamic pass) {
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(DEMSpacing.sm),
        side: BorderSide(
          color: DEMColors.primary.withValues(alpha: 0.2),
          width: 1,
        ),
      ),
      child: Padding(
