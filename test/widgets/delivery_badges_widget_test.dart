...
class _FakeDelivery {
  ...
  _FakeDelivery(this.id, this.distance, this.price, this.pickupAddress, this.dropoffAddress);
}

void main() {
  testWidgets('DeliveryBadgesWidget shows nothing when empty', (tester) async {
    await tester.pumpWidget(
      MaterialApp(home: Scaffold(body: Stack(children: [DeliveryBadgesWidget(deliveries: [], isPassActive: false)]))),
    );
