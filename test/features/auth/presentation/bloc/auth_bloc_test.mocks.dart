...
// in delivery_express_mobility_frontend/test/features/auth/presentation/bloc/auth_bloc_test.dart.
...
class MockLoginUseCase extends _i1.Mock implements _i3.LoginUseCase {
  ...
  @override
  _i4.Future<Map<String, dynamic>> call(
    String? phone,
    String? password,
  ) =>
      (super.noSuchMethod(
...
class MockSendOtpUseCase extends _i1.Mock implements _i3.SendOtpUseCase {
  ...
  @override
  _i4.Future<Map<String, dynamic>> call(String? phone) => (super.noSuchMethod(
        Invocation.method(
          #call,
          [phone],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockVerifyOtpUseCase extends _i1.Mock implements _i3.VerifyOtpUseCase {
  @override
  _i2.AuthRepository get repository => (super.noSuchMethod(
        Invocation.getter(#repository),
        returnValue: _FakeAuthRepository_0(
